========================================================================
    KONSOLENANWENDUNG: AmbientLibTest-Projektübersicht
========================================================================

Diese AmbientLibTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre AmbientLibTest-Anwendung besteht.


AmbientLibTest.vcxproj
...
AmbientLibTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "AmbientLibTest.pch und eine 
